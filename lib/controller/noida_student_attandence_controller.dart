...
class NoidaStudentAttandenceController extends GetxController {

  final _api = DashBoardRepo1();
  final rxRequestStatus = Status.Loading.obs;
  final  dataList =  Noida_school_wise_attandence().obs;
  RxString error = "".obs;
  void setRxRequestStatus(Status _value) => rxRequestStatus.value = _value;
  void setDataList( Noida_school_wise_attandence _value) => dataList.value = _value;
