...
class FacultyEmployeeLkoModel {
  String? message;
  EmployeeAttendenceModel? data;
  int? statuscode;
  int? totalCount;

  FacultyEmployeeLkoModel({this.message, this.data, this.statuscode, this.totalCount});

  FacultyEmployeeLkoModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      json['data'].forEach((v) {
        data = (new EmployeeAttendenceModel.fromJson(v));
      });
    }
...
class EmployeeAttendenceModel {
  ...
  EmployeeAttendenceModel.fromJson(Map<String, dynamic> json) {
