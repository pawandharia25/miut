class FinacialYearCollectionLkoModel {
  String? message;
  FinacialYearADataLkoModel? data;
  int? statuscode;
  int? totalCount;

  FinacialYearCollectionLkoModel(
      {this.message, this.data, this.statuscode, this.totalCount});

  FinacialYearCollectionLkoModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      json['data'].forEach((v) {
        data = (new FinacialYearADataLkoModel.fromJson(v));
      });
    }
...
class FinacialYearADataLkoModel {
  ...
  FinacialYearADataLkoModel.fromJson(Map<String, dynamic> json) {
