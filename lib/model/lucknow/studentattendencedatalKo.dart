class StudentAttendenceLkoModel {
  String? message;
  StudentAttendenceDatalkoModel? data;
  int? statuscode;
  int? totalCount;

  StudentAttendenceLkoModel(
      {this.message, this.data, this.statuscode, this.totalCount});

  StudentAttendenceLkoModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      json['data'].forEach((v) {
        data = (new StudentAttendenceDatalkoModel.fromJson(v));
      });
    }
...
class StudentAttendenceDatalkoModel {
  int? totalStudent;
  int? shiftIStudent;
  int? shiftIIStudent;
  int? shift2Admission;
  ...
  StudentAttendenceDatalkoModel.fromJson(Map<String, dynamic> json) {
