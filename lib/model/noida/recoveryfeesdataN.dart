class RecoveryFeesDataNModel {
  String? message;
  RecoveryFeesNModel? data;
  int? statuscode;
  int? totalCount;

  RecoveryFeesDataNModel(
      {this.message, this.data, this.statuscode, this.totalCount});

  RecoveryFeesDataNModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      json['data'].forEach((v) {
        data = (new RecoveryFeesNModel.fromJson(v));
      });
    }
...
class RecoveryFeesNModel {
  ...
  RecoveryFeesNModel.fromJson(Map<String, dynamic> json) {
