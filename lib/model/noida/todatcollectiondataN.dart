...
class TodayCollectionNModel {
  String? message;
  TodayCollectionDataNModel? data;
  int? statuscode;
  int? totalCount;

  TodayCollectionNModel({this.message, this.data, this.statuscode, this.totalCount});

  TodayCollectionNModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      json['data'].forEach((v) {
        data = (new TodayCollectionDataNModel.fromJson(v));
      });
    }
...
class TodayCollectionDataNModel {
  ...
  TodayCollectionDataNModel.fromJson(Map<String, dynamic> json) {
